      ...
      <div className="flex items-center justify-between">
        ...
        <div className="">
          <h1 className="text-gray-800 text-2xl md:text-5xl lg:text-6xl font-bold">
            D-Blog: Where Stories Come Alive
          </h1>
          <p className="mt-8 text-base md:text-xl ">
            Welcome to D-Blog — a simple space to share your thoughts, read
            fresh ideas, and connect with people who care.
          </p>
        </div>
        {/* animated button */}
        <Link to={"/write-post"} className="hidden md:block relative">
          <svg
            viewBox="0 0 200 200"
            width="200"
            height="200"
